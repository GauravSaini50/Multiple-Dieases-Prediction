...
diabetes_model = pickle.load(open(f'{working_dir}/Diabetic file/diabetic.pkl','rb'))
heart_disease_model = pickle.load(open(f'{working_dir}/Heart file/heart.pkl','rb'))
kidney_disease_model = pickle.load(open(f'{working_dir}/Kidney file/kindey.pkl','rb'))
NewBMI_Overweight=0
...
if selected == 'Diabetes Prediction':
    st.title("Diabetes Prediction Using Artificial Intelligence")
...
if selected == 'Heart Disease Prediction':
    st.title("Heart Disease Prediction Using Artificial Intelligence")
    col1, col2, col3  = st.columns(3)
...
if selected == 'Kidney Disease Prediction':
    ...
    st.title("Kidney Disease Prediction using Artificial Intelligence")
