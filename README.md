...
- Allowed users to input patient parameters and receive disease predictions in real-time
- Incorporated model confidence scores and ROC visualizations for intuitive understanding
- Made it accessible for demonstration and health screening use cases via browser


Tech Stack: Python, Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn,Streamlit
<img width="1908" height="847" alt="Screenshot 2025-07-16 212222" src="https://github.com/user-attachments/assets/3cccb67b-0416-424b-b4df-30c2d47c18b1" />
